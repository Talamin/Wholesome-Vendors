...
public class TrainingState : State
{
    ...
    private static bool needToTrain = LeveltoTrain.Exists(l => (int)ObjectManager.Me.Level >= l && PluginSettings.CurrentSetting.LastLevelTrained < l);

    private static List<int> LeveltoTrain = new List<int>
